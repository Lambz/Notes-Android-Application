...
public class VolleyParser {
    ...
    private List<HashMap<String, String>> getPlaces(JSONArray jsonArray) {
        ...
        HashMap<String, String> placeDictionary = new HashMap<>();
    ...
    private HashMap<String, String> getPlace(JSONObject jsonObject) {
        ...
        try {
            ...
            latitude = (String) jsonObject.getJSONObject("geometry").getJSONObject("location").getString("lat");
            longtitude = (String) jsonObject.getJSONObject("geometry").getJSONObject("location").getString("lng");
            ...
            googlePlaceDictionary.put("longitude",longtitude);
